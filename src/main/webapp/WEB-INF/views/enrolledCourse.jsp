...
<body class="w3-black" onload="document.f.username.focus()">
	...
	<div class="w3-padding-large" id="main">
		...
		<header class="w3-container w3-padding-32 w3-center w3-black"
			id="home">
		<h1 class="w3-jumbo">
			<span class="w3-hide-small">Enrolled </span>Page!
		</h1>
		<p>You enrolled the courses of next semester ( 1 semester, 2019 )!</p>
		</header>
	...
	<table class="viewCourses">
		...
		<c:forEach var="course" items="${courses}">
			<tr>
				...
				<td><c:out value="${course.subjectCord}"></c:out></td>
				<td><c:out value="${course.courseTitle}"></c:out></td>
				<td><c:out value="${course.classify}"></c:out></td>
